...
class Uart:
    ...
    def process_data(self,data):
        ...
        if "temperature" in data_from_sensor:
            self.client.publish("temp-da", data_from_sensor['temperature'])
        elif "light" in data_from_sensor:
            self.client.publish("light-da", data_from_sensor['light'])
        elif "humidity" in data_from_sensor:
            self.client.publish("humi-da", data_from_sensor['humidity'])
